...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "data-[state=active]:before data-[state=active]:before relative mb-2.5 flex w-full flex-1 items-center justify-center overflow-hidden whitespace-nowrap rounded-sm bg-muted p-8 text-base font-bold text-[#2148BF] shadow-sm ring-offset-white transition-all hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:before:absolute data-[state=active]:before:left-0 data-[state=active]:before:top-0 data-[state=active]:before:h-1 data-[state=active]:before:w-full data-[state=active]:before:bg-gradient-to-r data-[state=active]:before:from-[#24ABBF] data-[state=active]:before:to-[#24BFA0] dark:bg-slate-900 dark:text-white dark:shadow-slate-850/40 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-300 dark:data-[state=active]:bg-slate-900",
      className,
    )}
    {...props}
  />
